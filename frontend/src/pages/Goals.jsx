...
import { LineChart, AreaChart, Line, CartesianGrid, XAxis, YAxis, Area, ResponsiveContainer, Tooltip } from 'recharts';
...
const Goals = () => {
    ...
    return (
        <div className='w-full bg-neutral-100 '>
            ...
            <div className='flex gap-5 mx-4 my-2'>
                ...
                <div className='flex flex-col bg-white rounded-lg w-full p-6'>
                    <div className='flex pb-4 justify-between'>
                        <div className='flex gap-6'>
                            <p>Saving Summary</p>
                            <select name="" value={selectedMonth} onChange={handleMonthChange} id="">
                                {
